...
// Returns the private 'App\Repository\LivreDOrRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LivreDOrRepository.php';

return $this->privates['App\Repository\LivreDOrRepository'] = new \App\Repository\LivreDOrRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
