...
// Returns the private 'App\Repository\LienPhotoImageRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LienPhotoImageRepository.php';

return $this->privates['App\Repository\LienPhotoImageRepository'] = new \App\Repository\LienPhotoImageRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
