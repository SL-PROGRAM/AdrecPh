...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, array(
    ...
    'liip_imagine.command.remove_cache_command' => array('services', 'liip_imagine.command.remove_cache_command', 'getLiipImagine_Command_RemoveCacheCommandService.php', true),
    'liip_imagine.command.resolve_cache_command' => array('services', 'liip_imagine.command.resolve_cache_command', 'getLiipImagine_Command_ResolveCacheCommandService.php', true),
