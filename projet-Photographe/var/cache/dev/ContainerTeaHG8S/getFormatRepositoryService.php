...
// Returns the private 'App\Repository\FormatRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FormatRepository.php';

return $this->privates['App\Repository\FormatRepository'] = new \App\Repository\FormatRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
