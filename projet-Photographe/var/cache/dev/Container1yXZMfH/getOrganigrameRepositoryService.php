...
// Returns the private 'App\Repository\OrganigrameRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/OrganigrameRepository.php';

return $this->privates['App\Repository\OrganigrameRepository'] = new \App\Repository\OrganigrameRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
