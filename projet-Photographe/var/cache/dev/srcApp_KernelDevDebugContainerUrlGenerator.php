...
class srcApp_KernelDevDebugContainerUrlGenerator extends Symfony\Component\Routing\Generator\UrlGenerator
{
    ...
    public function __construct(RequestContext $context, LoggerInterface $logger = null, string $defaultLocale = null)
    {
        ...
        'accueil' => array(array('_locale'), array('_controller' => 'App\\Controller\\AccueilController::index'), array(), array(array('text', '/'), array('variable', '/', '[^/]++', '_locale', true)), array(), array()),
        'back_office_photo' => array(array('_locale'), array('_controller' => 'App\\Controller\\BackOfficePhotoController::index'), array(), array(array('text', '/back/office/photo'), array('variable', '/', '[^/]++', '_locale', true)), array(), array()),
        'back_office_text' => array(array('_locale'), array('_controller' => 'App\\Controller\\BackOfficeTextController::index'), array(), array(array('text', '/back/office/text'), array('variable', '/', '[^/]++', '_locale', true)), array(), array()),
        'commande' => array(array('_locale'), array('_controller' => 'App\\Controller\\CommandeController::index'), array(), array(array('text', '/commande'), array('variable', '/', '[^/]++', '_locale', true)), array(), array()),
        'contact' => array(array('_locale'), array('_controller' => 'App\\Controller\\ContactController::index'), array(), array(array('text', '/contact'), array('variable', '/', '[^/]++', '_locale', true)), array(), array()),
        'footer' => array(array('_locale'), array('_controller' => 'App\\Controller\\FooterController::index'), array(), array(array('text', '/footer'), array('variable', '/', '[^/]++', '_locale', true)), array(), array()),
        'galerie' => array(array('_locale'), array('_controller' => 'App\\Controller\\GalerieController::index'), array(), array(array('text', '/galerie'), array('variable', '/', '[^/]++', '_locale', true)), array(), array()),
        'gestion_admin' => array(array('_locale'), array('_controller' => 'App\\Controller\\GestionAdminController::index'), array(), array(array('text', '/gestion/admin'), array('variable', '/', '[^/]++', '_locale', true)), array(), array()),
        'gestion_photographe' => array(array('_locale'), array('_controller' => 'App\\Controller\\GestionPhotographeController::index'), array(), array(array('text', '/gestion/photographe'), array('variable', '/', '[^/]++', '_locale', true)), array(), array()),
        'header' => array(array('_locale'), array('_controller' => 'App\\Controller\\HeaderController::index'), array(), array(array('text', '/header'), array('variable', '/', '[^/]++', '_locale', true)), array(), array()),
        'identification' => array(array('_locale'), array('_controller' => 'App\\Controller\\IdentificationController::index'), array(), array(array('text', '/identification'), array('variable', '/', '[^/]++', '_locale', true)), array(), array()),
        'inscription' => array(array('_locale'), array('_controller' => 'App\\Controller\\InscriptionController::newPost'), array(), array(array('text', '/inscription'), array('variable', '/', '[^/]++', '_locale', true)), array(), array()),
        'logged_in' => array(array('_locale'), array('_controller' => 'App\\Controller\\LoggedInController::index'), array(), array(array('text', '/logged/in'), array('variable', '/', '[^/]++', '_locale', true)), array(), array()),
        'panier' => array(array('_locale'), array('_controller' => 'App\\Controller\\PanierController::index'), array(), array(array('text', '/panier'), array('variable', '/', '[^/]++', '_locale', true)), array(), array()),
        'particuliers' => array(array('_locale'), array('_controller' => 'App\\Controller\\ParticuliersController::contactAction'), array(), array(array('text', '/particuliers'), array('variable', '/', '[^/]++', '_locale', true)), array(), array()),
        'professionels' => array(array('_locale'), array('_controller' => 'App\\Controller\\ProfessionelsController::index'), array(), array(array('text', '/professionels'), array('variable', '/', '[^/]++', '_locale', true)), array(), array()),
        'app_logout' => array(array('_locale'), array('_controller' => 'App\\Controller\\SecurityController::logout'), array(), array(array('text', '/logout'), array('variable', '/', '[^/]++', '_locale', true)), array(), array()),
        'easyadmin' => array(array('_locale'), array('_controller' => 'EasyCorp\\Bundle\\EasyAdminBundle\\Controller\\EasyAdminController::indexAction'), array(), array(array('text', '/admin/'), array('variable', '/', '[^/]++', '_locale', true)), array(), array()),
        ...
        'homepage' => array(array(), array('path' => '/fr', 'permanent' => true, '_controller' => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\RedirectController::urlRedirectAction'), array(), array(array('text', '/')), array(), array()),
    );
        }
    }
