...
// Returns the private 'App\Repository\GaleryRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/GaleryRepository.php';

return $this->privates['App\Repository\GaleryRepository'] = new \App\Repository\GaleryRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
