...
// Returns the private 'App\Repository\SiteTextRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SiteTextRepository.php';

return $this->privates['App\Repository\SiteTextRepository'] = new \App\Repository\SiteTextRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
