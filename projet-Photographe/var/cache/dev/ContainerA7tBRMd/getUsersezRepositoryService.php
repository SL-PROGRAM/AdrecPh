...
// Returns the private 'App\Repository\UsersezRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UsersezRepository.php';

return $this->privates['App\Repository\UsersezRepository'] = new \App\Repository\UsersezRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
