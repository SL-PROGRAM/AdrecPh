...
// Returns the private 'App\Repository\SitePhotoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SitePhotoRepository.php';

return $this->privates['App\Repository\SitePhotoRepository'] = new \App\Repository\SitePhotoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
