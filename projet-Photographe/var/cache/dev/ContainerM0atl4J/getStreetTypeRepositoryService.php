...
// Returns the private 'App\Repository\StreetTypeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/StreetTypeRepository.php';

return $this->privates['App\Repository\StreetTypeRepository'] = new \App\Repository\StreetTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
